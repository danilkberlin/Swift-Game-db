            ...
            <div class="col-ld-6 col-md-6 col-sm-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <button class='w-100 fs-5 py-2 btn btn-outline-dark'>Know More</button>
                    </div> 
                </div>    
            </div>
        </div>
...
<section id='contact' class='contact' style='padding: 150px 0 50px 0;'>
    <div class="container">
        ...
        <div class="row justify-content-lg-between justify-content-md-center align-items-center my-5">
            <div class="col-lg-6 col-md-8 col-sm-12">
                <h2 class='text-center text-uppercase'>Write now</h2>
