<div class="offcanvas offcanvas-start text-bg-dark" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item m-2">
                <a class="nav-link rounded-2 px-4" href="save">
            ...
            <?php if($_SESSION['user_id'] === 42) { ?>
                <li class="nav-item m-2">
                    <a class="nav-link rounded-2 px-4 text-success" href="admin">
            ...
            <?php }?>
            <li class="nav-item m-2">
                <a class="nav-link rounded-2 px-4 text-danger" href="/user/signout">
