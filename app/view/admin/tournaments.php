                        ...
                        <div class="card text-bg-dark">
                            ...
                            <div class="card-body">
                                <table class="table table-dark table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach($mergedTournaments as $user): ?>
                                            <tr>
                                                <th scope="row">
                                                    <?php 
                                                        if($user['fk_user'] == NULL){
                                                            ...
                                                            echo isset($user['id']) ? $user['id'] : 'N/A'; 
                                                        }
                                                    ?>
                                                </th>
                                                <td>
                                                    <?php 
                                                        if($user['user_name_tournaments'] == NULL){
                                                            echo isset($user['login']) ? $user['login'] : 'N/A';
                                                        } else {
                                                ...
                                                <td>
                                                    <?php 
                                                        if($user['user_email_tournaments'] == NULL){
                                                            echo isset($user['email']) ? $user['email'] : 'N/A';
                                                        } else {
