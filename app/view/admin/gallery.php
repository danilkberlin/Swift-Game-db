...
<section class='my-5'>
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8 col-sm-10">
            <h3 class='text-center title-text-gradient fs-1'>Create new poto in gallery</h3>
            <div class="row justify-content-center">
                <div class="col-6">
                    <form action="/admin/gallery" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="gallery_foto" class="form-label text-color">Upload image</label>
                            <input type="url" class="form-control input-background" id="gallery_foto" name="gallery_foto" placeholder="Your link">
                        </div>
                        <div class="row justify-content-center">
