    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10 border rounded-2 py-5">
                <h1 class='text-center title-text-gradient my-3'>Sign up</h1>
                <form action="/user/register" method="post">   
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input name='email' class="form-control input-background w-100 mb-3" type='email' id="email">
                        </div>
                    </div>     
                    ...
                    <label for='repeatpass' class='text-color'>Your Repeat Password</label>
                    <input name='repeatpassword' class="form-control input-background w-100 mb-3" type='password' id="repeatpass">
    
                    <div class="row justify-content-center">
                        <div class="col-6 pt-4">
                            <button type="submit" class='btn btn-violet w-100 py-2 px-5'>
                                Submit
